 ...
 * @author rhhs
 */
public class ShooterPitchAngle extends PotentiometerPIDSubsystem {
    
    // Constants for preset positions 
    public static final double FLOOR_INTAKE_LOAD = -19.0; // Competition 38.0;
    public static final double FEEDER_STATION_LOAD = 30.0; // competition 28.0;
    public static final double SHOOT_PYRAMID_FRONT = 37.0;
    public static final double SHOOT_PYRAMID_BACK = 37.0;
    public static final double SHOOT_MAX_ANGLE = 40.0;
    public static final double SHOOT_HALF_COURT_RELATIVE_ANGLE = -6.0;
